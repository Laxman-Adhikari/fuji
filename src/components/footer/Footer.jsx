    ...
    return (
        ...
        <footer>
            ...
            <div className="foot-2">
                <p> Copyright &copy; {new Date().getFullYear()} FUJI INTERNATIONAL EDUCATIONAL CONSULTANCY </p>
            </div>

            <div className="foot-3">
                <h4 id="dev-detail"onClick={handleclick}> {clicked ? <div></div> : <div>Show Developer Details</div>} </h4>
                <h4 id={clicked ? null : "detail-1" } className={clicked ? "on1" : null }> Developed By: Komalhari Shrestha</h4>
                <h4 id={clicked ? null : "detail-2" }   className={clicked ? "on2" : null }> <img src={require("../../assets/img/mail-icon.png")} className="mail-icon" alt='' />komalhari777@gmail.com</h4>
            </div>
